...
│   │   ├── courses-section.tsx       # Clickable programs
│   │   ├── success-section.tsx       # Success carousel
│   │   ├── navigation.tsx            # Top navigation
│   │   ├── footer.tsx                # Footer
│   │   └── program-detail-modal.tsx  # Program modal
│   ├── pages/
│   │   ├── home.tsx                  # Home page
│   │   ├── programs.tsx              # Programs listing
│   │   ├── program-detail.tsx        # Individual program page
